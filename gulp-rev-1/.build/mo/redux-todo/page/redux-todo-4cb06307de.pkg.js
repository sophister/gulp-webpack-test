...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middlewareStore = __webpack_require__(193);

	var _middlewareStore2 = _interopRequireDefault(_middlewareStore);

	var _reactRedux = __webpack_require__(173);

	var _reduces = __webpack_require__(195);

	var _reduces2 = _interopRequireDefault(_reduces);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store = (0, _middlewareStore2.default)(_reduces2.default);
	var rootDom = document.getElementById("redux-container");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CalContainer = __webpack_require__(191);

	var _CalContainer2 = _interopRequireDefault(_CalContainer);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_CalContainer2.default, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoHeader = __webpack_require__(167);

	var _TodoHeader2 = _interopRequireDefault(_TodoHeader);

	var _action = __webpack_require__(169);

	var actionCreates = _interopRequireWildcard(_action);

	var _reactRedux = __webpack_require__(173);

	var _TodoFilters = __webpack_require__(166);

	var FilterConstants = _interopRequireWildcard(_TodoFilters);
	...
	var TodoContainer = function (_Component) {
	    ...
	    _createClass(TodoContainer, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            this.props.dispatch(actionCreates.fetchTodos()).then(function () {
	                console.log("callback call");
	                console.log(_this2.props.todos);
	            });
	        }
	    }, {
	        key: "_handleAddTodoClick",
	        value: function _handleAddTodoClick(text) {
	        ...
	        key: "_handleTodoListClick",
	        value: function _handleTodoListClick(index) {
	            console.log(index + " item 点击了!!!");
	            this.props.dispatch(actionCreates.completeTodoAction(index));
	        }
	    }, {
	        key: "_handleTodoFooterClick",
	        value: function _handleTodoFooterClick(type) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_AddTodo2.default, { onAddTodoClick: function onAddTodoClick(text) {
	                        return _this3._handleAddTodoClick(text);
	                    } }),
	                _react2.default.createElement(_TodoList2.default, { todos: this.props.todos, onTodoListClick: function onTodoListClick(index) {
	                        return _this3._handleTodoListClick(index);
	                    } }),
	                _react2.default.createElement(_TodoFooter2.default, { onTodoFooterClick: function onTodoFooterClick(type) {
	                        return _this3._handleTodoFooterClick(type);
	                    } })
	            );
	        }
	    }]);
	...
	exports.default = (0, _reactRedux.connect)(seletePropsFromState)(TodoContainer);
	    ...
	    _createClass(AddTodo, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "div",
	                null,
	                _react2.default.createElement("input", { type: "text", ref: "input", placeholder: "添加todo" }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoList = function (_Component) {
	    ...
	    _createClass(TodoList, [{
	        key: "handleTodoItemClick",
	        value: function handleTodoItemClick(index) {
	            this.props.onTodoListClick(index);
	        }
	    }, {
	        key: "handleOnCloseClick",
	        value: function handleOnCloseClick() {}
	    }, {
	        key: "render",
	        value: function render() {
	            var _this2 = this;
	            ...
	            return _react2.default.createElement(
	                ...
	                this.props.todos.map(function (todo, index) {
	                    return _react2.default.createElement(_TodoItem2.default, _extends({}, todo, {
	                        key: index,
	                        index: index,
	                        onTodoItemClick: function onTodoItemClick(index) {
	...
	var TodoItem = function (_Component) {
	    ...
	    _createClass(TodoItem, [{
	        ...
	        value: function render() {
	            ...
	            var completeClass = this.props.complete ? "complete" : "";
	            return _react2.default.createElement(
	                "li",
	                { className: "todoItem " + completeClass, onClick: function onClick(e) {
	                        return _this2.handleItemClick(e);
	                    } },
	                this.props.text
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoFooter = function (_Component) {
	    ...
	    _createClass(TodoFooter, [{
	        key: "renderFilter",
	        value: function renderFilter(type, name) {
	            var _this2 = this;
	            ...
	            return _react2.default.createElement(
	                ...
	                { href: "#", onClick: function onClick(e) {
	                        e.preventDefault();
	                        _this2.props.onTodoFooterClick(type);
	                    } },
	                " ",
	                name ? name : type,
	                " "
...
/***/ function(module, exports, __webpack_require__) {
	...
	var logoImg = __webpack_require__(168);
	...
	var TodoHeader = function (_Component) {
	    ...
	    _createClass(TodoHeader, [{
	        ...
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement("img", { ref: "img" });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "/n/static/mo/isomorphic/components/todo/react-ui/TodoHeader/assets/todoLogo-d4f35a3605.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function switchFileAction(filter) {
	    return {
...
/***/ function(module, exports) {
	...
	var SWITCH_FILTER = exports.SWITCH_FILTER = "SWITCH_FILTER";

	var REQUEST_TODOS = exports.REQUEST_TODOS = "REQUEST_TODOS";
	var RECEIVE_TODOS = exports.RECEIVE_TODOS = "RECEIVE_TODOS";

	var CAL_ADD = exports.CAL_ADD = "CAL_ADD";
	var CAL_MINUS = exports.CAL_MINUS = "CAL_MINUS";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCombineReducers = __webpack_require__(183);

	var _utilsCombineReducers2 = _interopRequireDefault(_utilsCombineReducers);

	var _utilsBindActionCreators = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsIsPlainObject = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapValues = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Calculator = __webpack_require__(192);
	...
	var CalContainer = function (_Component) {
	    _inherits(CalContainer, _Component);

	    function CalContainer() {
	        _classCallCheck(this, CalContainer);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(CalContainer).apply(this, arguments));
	    }

	    _createClass(CalContainer, [{
	        key: "_handleCalBtnClick",
	        value: function _handleCalBtnClick(calInfo) {
	            if (calInfo.type == "ADD") {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_Calculator2.default, { onCalBtnClick: function onCalBtnClick(calInfo) {
	                    return _this2._handleCalBtnClick(calInfo);
	                }, base: "2", calValue: this.props.calValue });
	        }
	    }]);
	...
	exports.default = (0, _reactRedux.connect)(selectPropsFromState)(CalContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Calculator = function (_Component) {
	    ...
	    _createClass(Calculator, [{
	        key: "_handleBtnClick",
	        value: function _handleBtnClick(type, e) {
	            var calInfo = {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "div",
	                { className: "calculator-component" },
	                _react2.default.createElement(
	                    "div",
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "button",
	                        { onClick: function onClick(e) {
	                                return _this2._handleBtnClick("ADD", e);
	                            } },
	                        "累加"
	                    ),
	                    _react2.default.createElement(
	                        "button",
	                        { onClick: function onClick(e) {
	                                return _this2._handleBtnClick("MIN", e);
	                            } },
	                        "递减"
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calculate = __webpack_require__(197);
	...
	var todoAppReduce = (0, _redux.combineReducers)({
	  todos: _todos.todoReduce,
	  showFilter: _todos.todoFilterReduce,
	  calValue: _calculate2.default
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.todoReduce = todoReduce;
	exports.todoFilterReduce = todoFilterReduce;
	...
	function todoReduce() {
	    ...
	    switch (action.type) {
	        ...
	        case actionTypes.COMPLETE_TODO:
	            return [].concat(_toConsumableArray(state.slice(0, action.payload.index)), [
	            //Object中的扩展运算符 ： http://es6.ruanyifeng.com/#docs/object
	            Object.assign({}, state[action.payload.index], { complete: true })], _toConsumableArray(state.slice(action.payload.index + 1)));
	            break;
	...
	function todoFilterReduce() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? _TodoFilters.ALL : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = calculateReduce;
